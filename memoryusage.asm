...
;-----------------------------------------------------------------------------------------------------------------------------------------------------
	...
	print "unused        ", page0100 - page0000End + page0287 - page0200End + page0d00 - page0287End, "bytes"
	print "free          ", screenAddr - page0000 - (page0000End - page0000 + page0200End - page0100 + page0287End - page0287 + programEnd - page0d00), "bytes"
	print "----------------------------------------------------"
	print
	print "----------------------------------------------------"
	...
	print "free          ", ~page0200End, "-", ~page0287 - 1, ".", page0287 - page0200End, "bytes"
	print "----------------------------------------------------"
