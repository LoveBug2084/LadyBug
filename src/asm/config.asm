...
defaultLadybugLives	= 3			; these values are used for a demo game instead of the player configured values
defaultEnemySpeed	= 1
...
;-----------------------------------------------------------------------------------------------------------------------------------------------------
	...
	equb 1					; sound enable		0-2 (0=off, 1=on without demo, 2=on with demo)
