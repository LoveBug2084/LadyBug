...
;-----------------------------------------------------------------------------------------------------------------------------------------------------
	...
	print "----------------------------------------------------"
	print "screen ram    ", ~screenAddr, "- ", ~page8000 - 1, ", ", page8000 - screenAddr, "bytes"
	print "----------------------------------------------------"
	print
	...
	print "unused        ", screenAddr - programEnd + page0d00 - page0287End + page0287 - page0258End + page0258 - page0200End + page0100 - page0000End, "bytes"
	print "----------------------------------------------------"
	print
	...
	print "unused        ", ~page0000End, "- ", ~page0100 - 1, ", ", page0100 - page0000End, "bytes"
	print "----------------------------------------------------"
	...
	print "unused        ", ~page0200End, "- ", ~page0258 - 1, ", ", page0258 - page0200End, "bytes"
	print "----------------------------------------------------"
	...
	print "unused        ", ~page0287End, "- ", ~page0d00 - 1, ", ", page0d00 - page0287End, "bytes"
	print "----------------------------------------------------"
