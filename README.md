...
BBC B+ 64K/128K (uses 12K workspace ram, no sideways ram needed)\
BBC Master 128K/Master Compact (uses 1 bank of sideways ram)
...
**note: video and screenshots from various builds during development but the game play is identical to the current build**\
